...
public class itemstack_v1_16_R2 implements ItemStackSupport {
    @Nullable
    ...
    public ItemStack addTag(ItemStack itemStack, String key, String value) {
        net.minecraft.server.v1_16_R2.ItemStack cis = CraftItemStack.asNMSCopy(itemStack);
    ...
    public org.bukkit.inventory.ItemStack applyPlayerSkinOnHead(Player player, org.bukkit.inventory.ItemStack copyTagFrom) {
        ...
        if (copyTagFrom != null) {
            net.minecraft.server.v1_16_R2.ItemStack i = CraftItemStack.asNMSCopy(head);
