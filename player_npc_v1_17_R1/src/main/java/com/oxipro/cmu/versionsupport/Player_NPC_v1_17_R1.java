...
public class Player_NPC_v1_17_R1 implements PlayerNPCSupport {
    ...
    public Player spawnNPC(Location location, GameProfile gameProfile) {
        ...
        EntityPlayer player = new EntityPlayer(((CraftServer) Bukkit.getServer()).getHandle().getServer(), worldServer, gameProfile);
        ...
        PacketPlayOutPosition position = new PacketPlayOutPosition(
                ...
                PacketPlayOutPosition.EnumPlayerTeleportFlags.a(0), player.getId(), false
        );
    ...
    public Player spawnNPC(Location location, Player playerToCopy, boolean copyArmor) {
        ...
        EntityPlayer player = new EntityPlayer(
                ((CraftServer) Bukkit.getServer()).getHandle().getServer(), worldServer,
        ...
        if (copyArmor) {
            ...
            armor.add(Pair.of(EnumItemSlot.f, playerToCopy.getInventory().getHelmet() == null ? new ItemStack(Item.getById(0)) : CraftItemStack.asNMSCopy(playerToCopy.getInventory().getHelmet())));
            armor.add(Pair.of(EnumItemSlot.e, playerToCopy.getInventory().getChestplate() == null ? new ItemStack(Item.getById(0)) : CraftItemStack.asNMSCopy(playerToCopy.getInventory().getChestplate())));
            armor.add(Pair.of(EnumItemSlot.d, playerToCopy.getInventory().getLeggings() == null ? new ItemStack(Item.getById(0)) : CraftItemStack.asNMSCopy(playerToCopy.getInventory().getLeggings())));
            armor.add(Pair.of(EnumItemSlot.c, playerToCopy.getInventory().getBoots() == null ? new ItemStack(Item.getById(0)) : CraftItemStack.asNMSCopy(playerToCopy.getInventory().getBoots())));
