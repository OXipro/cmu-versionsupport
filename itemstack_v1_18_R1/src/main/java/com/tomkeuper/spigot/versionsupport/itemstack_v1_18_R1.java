...
public class itemstack_v1_18_R1 implements ItemStackSupport {
    @Nullable
    ...
    public double getDamage(ItemStack itemStack) {
        ...
        if (nmsStack.s() == null) return 0D;
        return nmsStack.s().k("generic.attackDamage");
    }
